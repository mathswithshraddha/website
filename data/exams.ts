...
export const examsData: Exam[] = [
  ...
  },
  {
    ...
    name: "IPM",
    shortName: "IPM",
    fullForm: "Institute for Promotion of Mathematics",
    description: "Annual math competition focused on arithmetic fluency and mental math excellence.",
    fullDescription: "The Institute for Promotion of Mathematics (IPM) is an annual mathematics competition that focuses on arithmetic fluency, calculation speed, and mental math skills. It is conducted in two rounds - the qualifier and the final - testing students' mathematical agility and precision under time pressure.",
    conductingBody: "Institute for Promotion of Mathematics (IPM)",
